(function () {
    ...
    function reportException(qfile, err, cb, code) {
    ...
    function compile(dirs, file, options, cb) {
        locate(dirs, file, function (err, qfile) {
            if (err) {
                return reportException(file, err, cb);
            }
    ...
    module.exports = function (directories, options) {
        ...
        var dirs = Array.isArray(directories) ? directories : [ directories ],
            opts = options || {},
            compiledByFile = {};
        ...
        return function (req, res, next) {
            ...
            retrieve(dirs, file, opts, function (compiled) {
